...
public class ManageEmployee {
	...
	public static void main(String[] args) {
		...
		Integer empID4 = ME.addEmployee("Jag", "Gervacio", 200000);

		/* List down all the employees */
		// ME.listEmployees();

		/* Update employee's records */
		ME.updateEmployee(empID4, 5000);
	...
	public Integer addEmployee(String fname, String lname, int salary) {
		...
		Query q = session.createQuery("FROM Employee WHERE firstName = :fn");
		q.setParameter("fn", fname);
		List<Employee> chkEmployee = q.list();
		if(chkEmployee == null) {
		try {
			...
			employeeID = chkEmployee.get(0).getId();
